...
```
video-encode[2/2] HELD  node2 pid=4242 since=2026-06-12T10:15:00Z rev=8812
video-encode[2/2] HELD  node3 pid=991  since=2026-06-12T10:15:04Z rev=8814
video-encode[2/2] WAIT  node1 pid=1207 since=2026-06-12T10:15:09Z rev=8815
```
...
# at most 2 nodes run heavy tasks concurrently
conch sema heavy-jobs --max 2 -- /usr/local/bin/run-job.sh

# inspect
conch sema heavy-jobs --max 2 --who
```
