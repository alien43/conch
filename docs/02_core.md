...
| Flag | Env | Default |
| :--- | :--- | :--- |
| `--endpoints` | `CONCH_ENDPOINTS` | `asus-server:2379,dell-server:2379,rpi-server:2379` |
...
```json
{"host":"dell-server","pid":4242,"started":"2026-06-12T10:15:00Z","cmd":"incus start frobnitz"}
```
